 ...
 */
public class WaterCoachRegistryAdapter extends ArrayAdapter<WaterDailyRecord> {

    public WaterCoachRegistryAdapter(Context context, int resource, List<WaterDailyRecord> items) {
